<template>
    <NuxtLayout name="defaultmain" page_name="อันดับ">
        <div
            ...
            <div
                class="flex-auto flex flex-col min-h-full w-full px-10 sm:px-20 lg:px-24  sm:border-2 sm:border-b-0 sm:rounded-b-sm sm:rounded-2xl sm:border-[#9C9C9C] dark:border-[#545454]">

                <div class="flex-none flex justify-between px-8 sm:pt-10">
                    <div
                        class="flex items-center dark:text-[#FEFEFE] text-[20px] 2xl:text-[30px] 2xl:leading-7 xl:text-[28px] lg:text[26px] md:text-[24px] sm:text-[22px]">
                    ...
                    <div class="flex items-center space-x-2">
                        <DropdownCheckSelect
                            customclass="w-[200px] border-2 border-[#BABABA] bg-[#FEFEFE] text-[#606060] rounded-lg flex items-center justify-between p-2 drop-shadow-md xl:text-[18px] lg:text-[16px] md:text-[14px] sm:text-[12px] dark:text-[#8A8A8A] dark:bg-[#282828] dark:border-[#222222]"
                ...
                <div class="flex-none w-full px-8">
                    <div
                        class="flex flex-row border-2 rounded-2xl my-6 drop-shadow-lg h-fit border-[#00B191] text-[#FCFCFC] bg-[#00C7A3] dark:text-[#0F0F0F] dark:bg-[#3DD6BA] dark:border-[#00B191]">
                        <div
                        ...
                        <div class="basis-3/4 border-l-2 border-[#00B191]">
                            <p
                                class="ml-[calc(20%+40px)] text-[16px] 2xl:text-[26px] xl:text-[24px] lg:text[22px] md:text-[20px] sm:text-[18px]">
                                Name
                            </p>
                        </div>
                        <div
                ...
                <div v-if="loading" class="flex-auto h-full flex justify-center items-center ">
                    <div class="mx-auto flex items-center space-x-4">
                        <svg class=" animate-spin -ml-1 h-10 w-10 text-black" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="flex flex-col space-y-6 px-8">
                        <div v-for="(data, index) in rankingShow"
                            ...
                            <div class="basis-3/4 flex items-center">
                                <div
                                    class="mx-[10%] h-10 w-10 bg-slate-300 rounded-md overflow-hidden shadow-sm shadow-black/30">
